...
public class Program { // Define uma classe chamada Program.
    ...
    public static void main(String[] args) { // Define o método main, ponto de entrada do programa.
        ...
        //double p = (x.a + x.b + x.c) / 2.0; //trocar a lógica pela chamada da função criada na classe Triangle chamado área
        //double areaX = Math.sqrt(p * (p - x.a) * (p - x.b) * (p - x.c)); //trocar a lógica pela chamada da função criada na classe Triangle chamado área
        double areaX = x.area(); 
        
        // Cálculo da área do triângulo Y usando a fórmula de Herão.
        //p = (y.a + y.b + y.c) / 2.0; trocar a lógica pela chamada da função criada na classe Triangle chamado área
        //double areaY = Math.sqrt(p * (p - y.a) * (p - y.b) * (p - y.c)); trocar a lógica pela chamada da função criada na classe Triangle chamado área
        double areaY = y.area();
